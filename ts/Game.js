define(["require", "exports", "./Common/Canvas", "./Common/GameObject", "./Common/DisplayObject", "./Common/Coordinate", "./Common/EventLoop", "./DotField", "./GameState"], function (require, exports, Canvas_1, GameObject_1, DisplayObject_1, Coordinate_1, EventLoop_1, DotField_1, GameState_1) {
    "use strict";
    var Game = (function () {
        function Game() {
        }
        ...
        Game.prototype.run = function (window, document) {
            ...
            var ship = new GameObject_1.Ship(poly, new Coordinate_1.Coordinate(256, 240), 0, 0, 0, 0);
