...
export class ShapeLocatedData extends ShapeData implements ILocated {
    constructor(points: Coordinate[], public location: Coordinate) {
        super(points);
    }
}

export class ShapeLocatedAngledData extends ShapeLocatedData implements IAngled {
    constructor(points: Coordinate[], location: Coordinate, public angle: number = 0) {
        super(points, location);
    }
}

export class ShapeLocatedAngledMovingData extends ShapeLocatedAngledData implements IMoving {
...
export class ShapeLocatedAngledMovingRotatingData extends ShapeLocatedAngledMovingData implements IRotating {
...
export class ShapeLocatedAngledMovingRotatingAcceleratingData extends ShapeLocatedAngledMovingRotatingData {
