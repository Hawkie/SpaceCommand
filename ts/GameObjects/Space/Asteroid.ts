//import { IShape, ShapeData, IShapeLocated, IShapeLocatedMoving, IShapeLocatedAngledMovingRotataing, IShapeLocatedAngledMovingRotataingAccelerating } from "ts/Models/PolyModels";
...
export class Asteroid extends GameObject<AsteroidModel> {
    ...
    constructor(location: Coordinate, velx: number, vely: number, angle: number, spin: number) {
        var model: AsteroidModel = new AsteroidModel(location, velx, vely, angle, spin);
